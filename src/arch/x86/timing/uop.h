...
struct x86_uop_t
{
	...
	/* For memory uops */
    /* ... corresponding to 'uop->uinst->address' */
    //yk: uop->uinst->address is the virtual address of micro instruction
    //yk: multi2sim translate it to physical address in fetch stage(fetch.c:157)
