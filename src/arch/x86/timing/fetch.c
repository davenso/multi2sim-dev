...
static struct x86_uop_t *X86ThreadFetchInst(X86Thread *self, int fetch_trace_cache)
{
    ...
    // yk: here use functional simulation
    // the virtual memory address is calculated before hand.
    // addr is saved in micro instruction and translated into physical mem addr in fetch stage
