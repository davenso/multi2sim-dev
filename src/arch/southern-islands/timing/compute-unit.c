...
struct si_compute_unit_t *si_compute_unit_create()
{
    ...
    //yk: add scalar init
    compute_unit->scalar_unit.vtl_min = 0xffffffff;
    compute_unit->scalar_unit.vtl_max = 0x0;
    ...
    compute_unit->vector_mem_unit.l1_tlb =   xcalloc (TLB_ENTRY_NUM,  sizeof(struct gpu_tlb));
    compute_unit->vector_mem_unit.tlb_entry_num = 0;
    compute_unit->vector_mem_unit.tlb_miss = 0;
    compute_unit->vector_mem_unit.tlb_access = 0;
    compute_unit->vector_mem_unit.vtl_min = 0xffffffff;
    compute_unit->vector_mem_unit.vtl_max = 0x00000000;
