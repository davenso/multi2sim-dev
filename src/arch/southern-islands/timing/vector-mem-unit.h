...
#ifndef TLB_ENTRY_NUM
#define TLB_ENTRY_NUM 128
#endif
...
struct si_vector_mem_unit_t
{
    ...
    // yk: add TLB in this module
    // set contant size now
    struct gpu_tlb *l1_tlb;
    unsigned int tlb_entry_num;
    unsigned int tlb_fifo_ptr;
    unsigned int tlb_miss;
    unsigned int tlb_access;


    unsigned int vtl_min;
    unsigned int vtl_max;
